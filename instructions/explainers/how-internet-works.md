...
SYN (Synchronize): The client asks to open a connection.

SYN-ACK (Synchronize-Acknowledge): The server agrees and sends its own signal.

ACK (Acknowledge): The client confirms, and the session is live.
